...
exports.getOffsetForRowAndAlignment = exports.getOffsetForIndexAndAlignment = exports.getOffsetForColumnAndAlignment = exports.getItemMetadata = exports.getEstimatedTotalWidth = exports.getEstimatedTotalHeight = exports.getColumnWidthOrCalculate = exports.getColumnWidth = void 0;
exports.getRTLOffsetType = getRTLOffsetType;
exports.getRowOffset = exports.getRowHeightOrCalculate = exports.getRowHeight = void 0;
exports.getScrollbarSize = getScrollbarSize;
exports.hasOwn = void 0;
exports.isArray = isArray;
exports.isFunction = isFunction;
exports.mixClassNameSingle = mixClassNameSingle;
exports.refSetter = refSetter;
exports.sumColumnWidths = sumColumnWidths;
exports.sumRowsHeights = sumRowsHeights;
...
var getOffsetForIndexAndAlignment = function getOffsetForIndexAndAlignment(itemType, props, index, align, scrollOffset, instanceProps, scrollbarSize, sumOfLeftFixedColumnsWidth, sumOfRightFixedColumnsWidth) {
...
var getOffsetForColumnAndAlignment = function getOffsetForColumnAndAlignment(props, index, align, scrollOffset, instanceProps, scrollbarSize, sumOfLeftFixedColumnsWidth, sumOfRightFixedColumnsWidth) {
...
var getOffsetForRowAndAlignment = function getOffsetForRowAndAlignment(props, index, align, scrollOffset, instanceProps, scrollbarSize, sumOfLeftFixedColumnsWidth, sumOfRightFixedColumnsWidth) {
...
var getRowOffset = function getRowOffset(props, index, instanceProps) {
  return getItemMetadata("row", props, index, instanceProps).offset;
};
exports.getRowOffset = getRowOffset;
var getRowHeightOrCalculate = function getRowHeightOrCalculate(props, index, instanceProps) {
  return getItemMetadata("row", props, index, instanceProps).size;
};
exports.getRowHeightOrCalculate = getRowHeightOrCalculate;
var getRowHeight = function getRowHeight(props, index, instanceProps) {
  return instanceProps.rowMetadataMap[index].size;
};
exports.getRowHeight = getRowHeight;
var getColumnWidth = function getColumnWidth(props, index, instanceProps) {
  return instanceProps.columnMetadataMap[index].size;
};
exports.getColumnWidth = getColumnWidth;
var getColumnWidthOrCalculate = function getColumnWidthOrCalculate(props, index, instanceProps) {
  return getItemMetadata("column", props, index, instanceProps).size;
};
exports.getColumnWidthOrCalculate = getColumnWidthOrCalculate;
var size = -1;
...
function sumColumnWidths(columnWidthGetter, index) {
  if (index < 0) {
    return 0;
  }
...
function sumRowsHeights(rowHeightGetter, rows, index) {
  if (index < 0) {
    return 0;
  }
...
function mixClassNameSingle(classList1, classList2) {
