...
import { Grid, OnScrollCallback, OnScrollProps } from "./components/Grid";
...
import { GridChildComponentProps } from "./components/Cell";
...
export const VirtualTable = <RecordType extends Record<any, any>>(
  ...
  useDebounceEffect(reset, [originColumns], { wait: 500 });
